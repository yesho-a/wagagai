<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm " >
  ...
  <a href="#" class="brand-link logo-switch" style="background-color: white" >
    <img src="http://test-tms2020.herokuapp.com/assets/dist/img/alogo5.jpg" alt="AdminLTE Docs Logo Small" class="brand-image-xl logo-xs">
    <img src="http://test-tms2020.herokuapp.com/assets/dist/img/alogo2.jpg" alt="AdminLTE Docs Logo Large" class="brand-image-xl logo-xl" style="width:200px;">
  </a>
  <!-- Sidebar -->
  <div class="sidebar">
    ...
    <div class="user-panel mt-1 pb-1 mb-1 d-flex">
      <div class="image" style="margin-top:10px" >
        <img src="http://test-tms2020.herokuapp.com/assets/dist/img/photo.jpg"  class="img-circle " alt="User Image">
      </div>
      <div class="info">
        <a href="#" class="d-block"><b><h5> Yesho Simon </h5></b></a>
        <span>
